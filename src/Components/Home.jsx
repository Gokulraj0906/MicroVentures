        ...
        <div style={{ marginTop: '40px', padding: '20px' }}>
                  ...
                  <MDBCol md="6" lg="4" key={event.id}>
                    <MDBCard className="w-100">
                      <MDBCardBody>
                        ...
                        <MDBBtn href={event.eventRegistrationDetails} target="_blank" rel="noopener noreferrer" color="primary">
                          Learn More
                        </MDBBtn>
                      </MDBCardBody>
                    </MDBCard>
                  ...
                  <MDBCol md="6" lg="4" key={index}>
                    <MDBCard className="w-100">
                      <MDBCardBody>
                        ...
                        <MDBBtn href={article.url} target="_blank" rel="noopener noreferrer" color="success">
                          Read More
                        </MDBBtn>
                      </MDBCardBody>
                    </MDBCard>
          ...
          <footer className="text-center py-4 bg-dark text-white" style={{ position: 'relative' }}>
            <MDBContainer>
              ...
              <p>Developed by <a href="https://www.linkedin.com/in/gokulraj0906/" rel="noopener noreferrer" target='_blank'>GokulRaj.S</a> at Youngdevs Pvt Ltd.</p>
            </MDBContainer>
          </footer>
        </div>
      </MDBContainer>
