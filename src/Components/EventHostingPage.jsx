      ...
      <MDBCard className='text-black m-5' style={{ borderRadius: '25px', maxWidth: '800px' }}>
        <MDBCardBody>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <MDBRow className="mb-4">
              <MDBCol md='12'>
                <MDBInput label='Event Description' id='eventDescription' type='textarea' value={eventDetails.eventDescription} onChange={handleChange} required />
              </MDBCol>
            </MDBRow>
            <MDBRow>
              <MDBCol md='16'>
            ...
            <center>
            <MDBBtn className='mt-4' size='lg' type="submit">Submit</MDBBtn></center>
          </form>
        </MDBCardBody>
      </MDBCard>
    </MDBContainer>
