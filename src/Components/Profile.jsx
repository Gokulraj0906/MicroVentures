...
import { MDBContainer, MDBRow, MDBCol, MDBBtn, MDBCard, MDBCardBody, MDBInput, MDBAlert } from 'mdb-react-ui-kit';
        ...
        <MDBCardBody>
          ...
          <MDBRow className="mt-4">
            <MDBCol md="12" className="text-center">
              <MDBBtn onClick={handleSaveProfile} disabled={loading} color="primary" style={{ width: '100%', fontSize: '1.1rem', padding: '10px' }}>
